...
type StudentAttsUsecase interface {
	...
	GetReport(academicID, levelID, classID, termID int, search, start_date, end_date, state string) (dto.GetStudentAttsReport, error)
...
func (s *studentAttsUsecase) GetReport(academicID, levelID, classID, termID int, search, start_date, end_date, state string) (dto.GetStudentAttsReport, error) {
	if start_date == "" || end_date == "" {
		return dto.GetStudentAttsReport{}, nil
	}
	studentAtts, err := s.studentAttsRepository.GetReport(academicID, levelID, classID, termID, search, start_date, end_date, state)
	if err != nil {
